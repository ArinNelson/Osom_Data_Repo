function status = nc_gen_narr_data(file_name,ni,nj,nt,var_name)
...
%                 );
  ...
  netcdf.putAtt(ncid,-1,'source','North American Regional Reanalysis (NARR)');
  netcdf.putAtt(ncid,-1,'history',['generated by nc_gen_narr_data.m on ' datestr(now)]);
