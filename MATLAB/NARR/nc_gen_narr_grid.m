function status = nc_gen_narr_grid(filename,ni,nj)
...
%                 );
  ...
  netcdf.putAtt(ncid,-1,'history',['generated by nc_gen_narr_grid.m on ' datestr(now)]);
 ...
 % Dimensions
  ...
  varid(end+1) = netcdf.defVar(ncid,'mask','NC_SHORT',[dimid(1) dimid(2)]);
