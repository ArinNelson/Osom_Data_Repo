function status = nc_gen_frc_roms(file_name,nx,ny,var_to_incl,varargin)
    ...
    if(~isempty(varargin))
        netcdf.putAtt(ncid,nc_global,'title',varargin{1});
    end
    ...
    switch var_to_incl{i}
        case 'wind';	dimid(end+1) = netcdf.defDim(ncid,'wind_time',nc_unlimited);
