%=========================================================================%
% gather_nam_218_grid.m
% Gather North American Mesoscale (NAM) model grid-218 product grid
% by Arin Nelson
% on 08/14/2021
%=========================================================================%
addpath('../Utilities');
...
data_dir      = 'F:/OSOM_Data_Repo/NAM_218/'; % Location where to save
grid_filename = 'nam218_grid.nc';             % grid file name
lon_lim       = [-74.0 -69.0];                % longitude domain
lat_lim       = [ 40.0  42.5];                % latitude domain

% Constants
mask_url = 'https://www.ncei.noaa.gov/thredds/dodsC/model-nam218-old/202005/20200501/nam_218_20200501_0000_000.grb2';
...
nam_x    = nam_x(ii);
nam_y    = nam_y(jj);
nam_mask = ncread_web(max_wait,mask_url,'Land_cover_0__sea_1__land_surface',[nam_i0 nam_j0 1],[nam_ni nam_nj 1]);
