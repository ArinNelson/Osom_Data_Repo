%=========================================================================%
% gather_nam_anl.m
% Gather North American Mesoscale (NAM) model grid-218 product
% by Arin Nelson
% on 08/14/2021
%
% Example file url for testing/debugging:
% dat_url = 'https://www.ncei.noaa.gov/thredds/dodsC/model-nam218-old/201906/20190601/namanl_218_20190601_0000_000.grb';
% 
...
% Options
date_start = [2020,01,01];     % Start year, month, day to gather data for
date_end   = [2020,01,31];     % End   year, month, day to gather data for
...
data_dir   = 'F:/OSOM_Data_Repo/NAM_218/';  % My desktop
grid_file  = [data_dir 'nam218_grid.nc'];  % Grid file
var_to_get = {'lwrad','swrad','wind','Pair','Tair','Qair','rain','Cfra'};

%-------------------------------------------------------------------------%

% Constants
date_min = [2019,06,18; 2020,05,18];
date_max = [2020,05,15; 2020,12,31];
base_url = 'https://www.ncei.noaa.gov/thredds/';
data_url = {'model-nam218-old/', ...
            'model-nam218/', ...
           };
